...
@Service
public class ScholarshipGraduatesDataPointService implements ScholarshipDataPointService {
                ...
                scholarshipAccomplishmentDto -> {
                    ...
                    switch (dataPointType) {
                        ...
                        case OUTPUT:
                            ...
                            break;
                        case RATE:
                            dataPoints.setValue(scholarshipAccomplishmentDto.getPhysicalAccomplishmentDto().getGraduatesUtilization().longValue());
                            break;
                        default:
                            break;
                    }
