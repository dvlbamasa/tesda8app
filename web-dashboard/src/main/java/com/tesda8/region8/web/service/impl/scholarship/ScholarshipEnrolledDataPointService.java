...
@Service
public class ScholarshipEnrolledDataPointService implements ScholarshipDataPointService {
    ...
    private void checkDataPointType(DataPointType dataPointType, List<DataPoints> dataPointsList, ScholarshipAccomplishmentDto scholarshipAccomplishmentDto, DataPoints dataPoints) {
        switch (dataPointType) {
            case TARGET:
                dataPoints.setValue(scholarshipAccomplishmentDto.getQualificationMapDto().getSlots());
                break;
            case OUTPUT:
                dataPoints.setValue(scholarshipAccomplishmentDto.getPhysicalAccomplishmentDto().getEnrolled());
                break;
            case RATE:
                dataPoints.setValue(scholarshipAccomplishmentDto.getPhysicalAccomplishmentDto().getEnrolledUtilization().longValue());
                break;
            default:
                break;
        }
