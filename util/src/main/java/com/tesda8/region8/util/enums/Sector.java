...
public enum Sector {
    ...
    HVACR("Heating, Ventilation, Air Conditioning and Refrigeration", "TTI"),
    ICT("Information and Communications Technology", "TTI"),
    ...
    TOURISM("Tourism (Hotels and Restaurants)", "TTI"),
    TVET("TVET", "TTI"),
    VISUAL_ARTS("Visual Arts", "NON-TTI"),
    MARITIME("Maritime", "NON-TTI"),
    WHOLESALE("Wholesale and Retail Trading", "TTI"),
